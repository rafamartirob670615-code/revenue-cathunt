  ...
  return (
    <div className="revenue-platform">
      <aside className="revenue-sidebar">
        ...
        <footer><i /><span><b>{identity.displayName}</b><small>{FUNCTION_LABELS[identity.functions[0]]} · espacio privado</small><small className="copyright">© 2026 REVENUE · CatHunt</small></span></footer>
      </aside>
