...
export type BaselineResult = {
  ...
  lines: Array<{ accountId: string; skuId: string; period: string; calculatedUnits: number; observedUnits?: number[]; confidence: number }>;
  annualUnits: number;
