export const SYNTHETIC_DATA_LABEL = "DATOS SINTÉTICOS — NO COMERCIALES";
  ...
  return [
    {
      ...
      filename: "SINTETICO_NO_COMERCIAL_historia_ventas.csv",
      content: csv(
    ...
    },
    {
      ...
      filename: "SINTETICO_NO_COMERCIAL_catalogo_correspondencias.csv",
      content: csv(
    ...
    },
    {
      ...
      filename: "SINTETICO_NO_COMERCIAL_conversiones.csv",
      content: csv(
    ...
    },
    {
      ...
      filename: "SINTETICO_NO_COMERCIAL_precios.csv",
      content: csv(
    ...
    },
    {
      ...
      filename: "SINTETICO_NO_COMERCIAL_actividades.csv",
      content: csv(
